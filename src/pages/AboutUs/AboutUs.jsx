...
const AboutUs = () => {
  ...
  const libraryImageUrl = "https://images.unsplash.com/photo-1512820790803-83ca734da794?auto=format&fit=crop&w=1200&q=80";
  const teamImageUrl = "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=1200&q=80";
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center mb-16 md:mb-24">
            <div data-aos="fade-right" className="relative group">
              ...
              <img
                ...
                onError={(e) => { e.target.onerror = null; e.target.src = "https://placehold.co/600x400/1e293b/94a3b8?text=Book+Haven"; }}
              />
            </div>
            <div data-aos="fade-left" className="prose prose-invert prose-lg max-w-none">
              <h2 className="text-3xl sm:text-4xl font-semibold mb-5 text-blue-400">Our Story</h2>
              <p>
                BookBarn was forged in the crucible of passion for literature, with a singular mission: to democratize reading and make the boundless universe of books accessible to all.
              </p>
              <p>
                We champion the transformative power of narratives—their capacity to ignite inspiration, disseminate wisdom, and reshape destinies.
              </p>
            </div>
          </div>
          ...
          <div className="mb-16 md:mb-24 text-center" data-aos="zoom-in-up">
            ...
            <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
              {[
                { icon: BookHeart, title: "Passion for Reading", text: "Fostering a lifelong love for books." },
                { icon: Users, title: "Community Centric", text: "Building a vibrant space for book lovers." },
                { icon: Target, title: "Accessibility for All", text: "Making literature available to everyone." },
              ].map(({ icon: Icon, title, text }, i) => (
                <div key={i} className="bg-base-200 p-6 rounded-xl shadow-md border border-gray-700 hover:border-purple-500 transition-all transform hover:-translate-y-1">
          ...
          {/* Section 2 */}
          <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center mb-16 md:mb-24">
            <div data-aos="fade-left" className="prose prose-invert prose-lg max-w-none md:order-2">
              <h2 className="text-3xl sm:text-4xl font-semibold mb-5 text-blue-400">Meet the Curators</h2>
              <p>
                Behind BookBarn is a dedicated crew of bibliophiles, tech wizards, and dreamers, united by a shared love for stories.
              </p>
              <p>
                Whether you’re a casual reader or a seasoned bibliophile, BookBarn is your celestial guide to celebrate the enduring magic of books.
              </p>
            </div>
            <div data-aos="fade-right" className="relative group md:order-1">
              ...
              <img
                ...
                alt="Team"
                className="relative rounded-2xl shadow-xl hover:scale-[1.03] transition-transform duration-500 ease-in-out aspect-video object-cover"
                onError={(e) => { e.target.onerror = null; e.target.src = "https://placehold.co/600x400/1e293b/94a3b8?text=Our+Team"; }}
              />
            </div>
          </div>
          ...
          <div className="mt-16 md:mt-20 text-center" data-aos="zoom-in">
            ...
            <div className="flex justify-center gap-6 sm:gap-8">
              <a href="#" className="text-slate-400 hover:text-purple-400 transition-colors duration-300 transform hover:scale-110" aria-label="Facebook">
                <Facebook size={32} />
              </a>
              <a href="#" className="text-slate-400 hover:text-indigo-400 transition-colors duration-300 transform hover:scale-110" aria-label="Twitter">
                <Twitter size={32} />
              </a>
              <a href="#" className="text-slate-400 hover:text-pink-400 transition-colors duration-300 transform hover:scale-110" aria-label="Instagram">
                <Instagram size={32} />
              </a>
            </div>
          </div>
